...
namespace daw {
	...
	constexpr std::uint16_t operator<<( std::uint16_t b, UInt16 shift ) noexcept {
		...
		b = static_cast<std::uint16_t>( static_cast<std::uint32_t>( b )
	...
	constexpr std::uint16_t &operator+=( std::uint16_t &lhs,
	                                     UInt16 rhs ) noexcept {
		lhs = static_cast<std::uint16_t>( static_cast<std::uint32_t>( lhs ) +
		                                  static_cast<std::uint32_t>( rhs ) );
		return lhs;
	}
	...
	constexpr std::uint8_t operator<<( std::uint8_t b, UInt8 shift ) noexcept {
		...
		b = static_cast<std::uint8_t>( static_cast<std::uint32_t>( b )
		                               << static_cast<std::uint32_t>( shift ) );
		return b;
	}
